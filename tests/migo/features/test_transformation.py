...
from migo.features.transformation import (
    THTransformation,
    index_to_onehot,
    onehot_to_index,
...
class TestTHTransformation:
    def test_rotate_90(self):
        ...
        expected_planes = np.array([[[1, 0], [0, 0]], [[0, 0], [1, 0]]])

        npt.assert_array_equal(
            THTransformation.rotate_90(planes), expected_planes
        )

    def test_rotate_180(self):
        planes = np.array([[[0, 1], [0, 0]], [[1, 0], [0, 0]]])

        expected_planes = np.array([[[0, 0], [1, 0]], [[0, 0], [0, 1]]])

        npt.assert_array_equal(
            THTransformation.rotate_180(planes), expected_planes
        )
    ...
    def test_rotate_270(self):
        ...
        npt.assert_array_equal(
            THTransformation.rotate_270(planes), expected_planes
        )

    def test_fliplr(self):
        planes = np.array([[[0, 1], [0, 0]], [[1, 0], [0, 0]]])

        expected_planes = np.array([[[1, 0], [0, 0]], [[0, 1], [0, 0]]])
    ...
    def test_diagonal_left_down(self):
        ...
        expected_planes = np.array([[[0, 1], [0, 0]], [[0, 0], [0, 1]]])

        npt.assert_array_equal(
            THTransformation.diagonal_left_down(planes), expected_planes
        )
    ...
    def test_diagonal_right_down(self):
        ...
        npt.assert_array_equal(
            THTransformation.diagonal_right_down(planes), expected_planes
        )
    ...
    def test_transform_index_rotate_90(self):
        ...
        actual_action = transform_index(
            move_to_index(action, size), THTransformation.rotate_90, size
        )
    ...
    def test_transform_index_rotate_180(self):
        ...
        actual_action = transform_index(
            move_to_index(action, size), THTransformation.rotate_180, size
        )
    ...
    def test_transform_index_rotate_270(self):
        ...
        actual_action = transform_index(
            move_to_index(action, size), THTransformation.rotate_270, size
        )
    ...
    def test_transform_index_fliplr(self):
        ...
        expected_action = move_to_index((0, 8), size)
        actual_action = transform_index(
            move_to_index(action, size), THTransformation.fliplr, size
        )
    ...
    def test_transform_index_flipud(self):
        ...
        expected_action = move_to_index((8, 0), size)
        actual_action = transform_index(
            move_to_index(action, size), THTransformation.flipud, size
        )
    ...
    def test_transform_index_pass(self):
        ...
        for action in actions:
            with pytest.raises(AssertionError):
                transform_index(
                    action,  # ty: ignore[invalid-argument-type]
                    THTransformation.diagonal_right_down,
                    size,
                )
    ...
    def test_rotate_features_and_action_when_action_is_pass(self):
        ...
        expected_action = 2**2
        expected_planes = np.array([[[0, 1], [0, 0]], [[1, 0], [0, 0]]])

        actual_plane, actual_action = rotate_features_and_action(
            planes, action, 2, THTransformation.identity
        )
